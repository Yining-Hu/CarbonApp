        ...
        if (!paramerrors.isEmpty()) {
            ...
            mpinstance.then(value => {
                ...
                .catch((error) => {
                    ...
                    if (error.message.includes("gas")) {
                    ...
                    } else if (error.message.includes("Product is already listed.")) {
                        ...
                        response.write(JSON.stringify({"Txn":txnhash, "server_response":"Txn reverted. Product token is not minted. Please mint token before listing."}));
                    } else {
    ...
    (request, response) => {
        ...
        if (!paramerrors.isEmpty()) {
            ...
            mpinstance.then(value => {
                ...
                .catch((error) => {
                    var txnhash = Object.keys(error.data)[0];
                    console.log(`Failed to purchase product: ${productid}, Txn hash: ${txnhash}`);
                    console.log(error);
